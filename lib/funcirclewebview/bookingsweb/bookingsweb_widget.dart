...
import 'bookingsweb_model.dart';
export 'bookingsweb_model.dart';

/// Homepage
///
class BookingswebWidget extends StatefulWidget {
  const BookingswebWidget({super.key});

  static String routeName = 'Bookingsweb';
  static String routePath = '/bookingsweb';

  @override
  State<BookingswebWidget> createState() => _BookingswebWidgetState();
}

class _BookingswebWidgetState extends State<BookingswebWidget> {
  late BookingswebModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BookingswebModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('Bookingsweb_request_permissions');
      await requestPermission(locationPermission);
      if (await getPermissionStatus(locationPermission)) {
        if (currentUserDocument?.latlong != null) {
          logFirebaseEvent('Bookingsweb_update_app_state');
            ...
            child: Column(
              ...
              children: [
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    if (_model.url ==
                                        'https://www.funcircleapp.com/bookings?headhide=true&lcnbtn=hide')
                                      InkWell(
                ...
                custom_widgets.WebViewWithUrlTracking(
                  ...
                  initialUrl:
                      'https://funcircleapp.com/bookings?headhide=true&lcnbtn=hide',
