...
class _RequestsWidgetState extends State<RequestsWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('Requests_backend_call');
      _model.apiResultez3 = await GetinterestedrequestsCall.call(
        otherUserId: currentUserUid,
      );

      if ((_model.apiResultez3?.succeeded ?? true)) {
        logFirebaseEvent('Requests_update_page_state');
        _model.requestidslist = GetinterestedrequestsCall.requestids(
          (_model.apiResultez3?.jsonBody ?? ''),
        )!
            .toList()
            .cast<int>();
        safeSetState(() {});
                  ...
                  children: [
                    Align(
                      ...
                      child: TabBar(
                        ...
                        indicatorColor: Color(0xFF52105A),
                        padding: EdgeInsets.all(4.0),
                        tabs: [
                          Tab(
                            text: FFLocalizations.of(context).getText(
                              'jns66bax' /* All requests */,
                            ),
                          ),
                          Tab(
                            text: FFLocalizations.of(context).getText(
                              'hiqdsl4a' /* My Requests */,
                            ),
                          ),
                        ],
