...
T? getParameter<T>(Map<String, dynamic> data, String paramName) {
  try {
    ...
    switch (T) {
      ...
      case GlitchesRow:
        return GlitchesRow(json.decode(param) as Map<String, dynamic>) as T;
      case GroupcategoriesRow:
        return GroupcategoriesRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case GameRequestsRow:
        return GameRequestsRow(json.decode(param) as Map<String, dynamic>) as T;
      case UserlikesRow:
        return UserlikesRow(json.decode(param) as Map<String, dynamic>) as T;
      case RequestsRow:
        return RequestsRow(json.decode(param) as Map<String, dynamic>) as T;
      case UserpromptsRow:
        return UserpromptsRow(json.decode(param) as Map<String, dynamic>) as T;
      case TicketsRow:
        return TicketsRow(json.decode(param) as Map<String, dynamic>) as T;
      case SquadsRow:
        return SquadsRow(json.decode(param) as Map<String, dynamic>) as T;
      case UserprofilecompletionstatusRow:
        return UserprofilecompletionstatusRow(
            json.decode(param) as Map<String, dynamic>) as T;
      case InterestedRequestsRow:
        return InterestedRequestsRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case GroupsRow:
        return GroupsRow(json.decode(param) as Map<String, dynamic>) as T;
      case InterestsRow:
        return InterestsRow(json.decode(param) as Map<String, dynamic>) as T;
      case DuosRow:
        return DuosRow(json.decode(param) as Map<String, dynamic>) as T;
      case WaitlistRow:
      ...
      case VenuesRow:
        return VenuesRow(json.decode(param) as Map<String, dynamic>) as T;
      case UserstogroupsRow:
        return UserstogroupsRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case PromptsRow:
        return PromptsRow(json.decode(param) as Map<String, dynamic>) as T;
      case TagsRow:
        return TagsRow(json.decode(param) as Map<String, dynamic>) as T;
      case UsersRow:
        return UsersRow(json.decode(param) as Map<String, dynamic>) as T;
      case DiscountTableRow:
        return DiscountTableRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case OrderitemsRow:
        return OrderitemsRow(json.decode(param) as Map<String, dynamic>) as T;
      case ConnectionsRow:
        return ConnectionsRow(json.decode(param) as Map<String, dynamic>) as T;
      case OrdersRow:
        return OrdersRow(json.decode(param) as Map<String, dynamic>) as T;
      case SubscriptionRow:
        return SubscriptionRow(json.decode(param) as Map<String, dynamic>) as T;
    }
    if (param is String) {
