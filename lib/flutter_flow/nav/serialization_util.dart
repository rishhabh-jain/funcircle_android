  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case GlitchesRow:
            return GlitchesRow(data);
          case GroupcategoriesRow:
            return GroupcategoriesRow(data);
          case GameRequestsRow:
            return GameRequestsRow(data);
          case UserlikesRow:
            return UserlikesRow(data);
          case RequestsRow:
            return RequestsRow(data);
          case UserpromptsRow:
            return UserpromptsRow(data);
          case TicketsRow:
            return TicketsRow(data);
          case SquadsRow:
            return SquadsRow(data);
          case UserprofilecompletionstatusRow:
            return UserprofilecompletionstatusRow(data);
          case InterestedRequestsRow:
            return InterestedRequestsRow(data);
          case GroupsRow:
            return GroupsRow(data);
          case InterestsRow:
            return InterestsRow(data);
          case DuosRow:
            return DuosRow(data);
          case WaitlistRow:
          ...
          case DiscountTableRow:
            return DiscountTableRow(data);
          case OrderitemsRow:
            return OrderitemsRow(data);
          case ConnectionsRow:
            return ConnectionsRow(data);
          case OrdersRow:
